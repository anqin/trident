...
#ifndef _TRIDENT_TIMEOUT_MANAGER_H_
#define _TRIDENT_TIMEOUT_MANAGER_H_
...
private:
    ...
    TRIDENT_DISALLOW_EVIL_CONSTRUCTORS(TimeoutManager);
};


} // namespace trident

#endif // _TRIDENT_TIMEOUT_MANAGER_H_
